...
Function SetAllies(Faction akFaction, FormList akFactions) Global
  Int i = 0
  While i < akFactions.GetSize()
    (akFactions.GetAt(i) as Faction).SetAlly(akFaction)
    i += 1
  EndWhile
EndFunction


Function SetEnemies(Faction akFaction, FormList akFactions) Global
  Int i = 0
  While i < akFactions.GetSize()
    (akFactions.GetAt(i) as Faction).SetEnemy(akFaction)
    i += 1
  EndWhile
EndFunction


Function SetFriends(Faction akFaction, FormList akFactions) Global
  Int i = 0
  While i < akFactions.GetSize()
    (akFactions.GetAt(i) as Faction).SetAlly(akFaction, true, true)
    i += 1
  EndWhile
EndFunction


Function SetNeutrals(Faction akFaction, FormList akFactions) Global
  Int i = 0
  While i < akFactions.GetSize()
    (akFactions.GetAt(i) as Faction).SetEnemy(akFaction, true, true)
    i += 1
  EndWhile
EndFunction
